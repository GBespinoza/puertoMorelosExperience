...
$subject = "Experiencie Puerto Morelos - Unlimited Pass";
...
$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>nombre</p></td><td>" . strip_tags($_POST['nombreUnlimited']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Email</p></td><td>" . strip_tags($_POST['emailUnlimited']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Phone</p></td><td>" . strip_tags($_POST['telUnlimited']) . "</td></tr>";
