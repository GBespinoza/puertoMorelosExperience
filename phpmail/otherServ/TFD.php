...
$subject = "Experiencie Puerto Morelos - TFD";
...
$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>nombre</p></td><td>" . strip_tags($_POST['nombre4']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Email</p></td><td>" . strip_tags($_POST['email4']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Phone</p></td><td>" . strip_tags($_POST['telefono4']) . "</td></tr>";
