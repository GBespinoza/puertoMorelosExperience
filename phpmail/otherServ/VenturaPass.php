...
$subject = "Experiencie Puerto Morelos - Ventura Pass";
...
$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>nombre</p></td><td>" . strip_tags($_POST['nombreVentura']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Email</p></td><td>" . strip_tags($_POST['emailVentura']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Phone</p></td><td>" . strip_tags($_POST['telVentura']) . "</td></tr>";
