...
$subject = "Experiencie Puerto Morelos - DSP";
...
$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Email</p></td><td>" . strip_tags($_POST['email2']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Phone</p></td><td>" . strip_tags($_POST['tel2']) . "</td></tr>";
