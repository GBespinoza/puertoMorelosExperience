...
$subject = "Experiencie Puerto Morelos - Contacts";
...
$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>mail</p></td><td>" . strip_tags($_POST['mail']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin:  0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Subject</p></td><td>" . strip_tags($_POST['Subject']) . "</td></tr>";

$message .= "<tr><td style='padding: 10px;width: 20%;'><p style='margin: 0;font-size:18px;color: #ab761c;font-family:Lucida Sans Unicode;'>Message</p></td><td>" . strip_tags($_POST['Message']) . "</td></tr>";
